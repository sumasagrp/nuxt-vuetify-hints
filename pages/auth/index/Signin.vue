...
<template>
  <VForm
    ref="formRef" v-bind="{ ...formOptions }" v-model="validated" ...emailField v-model="credentials.email" {@submit.prevent="handleSignIn>
    <VRow dense>
      <VCol>
        <VTextField v-bind=" }"
  />
  ...
  <VRow dense>
    ...
    <VCol
      class="justify-sm-end flex items-center" cols="12" sm="6>
